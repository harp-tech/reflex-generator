...
_mask2col = [
    ...
    ColumnParser(api_name="mask_family", column_name="MaskFamily"),
    ColumnParser(api_name="mask", column_name="Mask", allow_none=False),
    ColumnParser(api_name="dtype", column_name="Format", allow_none=False),
    ColumnParser(api_name="description", column_name="Description"),
